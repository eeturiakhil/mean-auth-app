...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _globals__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ./globals */
    "./src/app/globals.ts");
    /* harmony import */
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_8__["AppComponent"], _components_navbar_navbar_component__WEBPACK_IMPORTED_MODULE_9__["NavbarComponent"], _components_login_login_component__WEBPACK_IMPORTED_MODULE_10__["LoginComponent"], _components_register_register_component__WEBPACK_IMPORTED_MODULE_11__["RegisterComponent"], _components_home_home_component__WEBPACK_IMPORTED_MODULE_12__["HomeComponent"], _components_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_13__["DashboardComponent"], _components_profile_profile_component__WEBPACK_IMPORTED_MODULE_14__["ProfileComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_7__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], angular2_flash_messages__WEBPACK_IMPORTED_MODULE_4__["FlashMessagesModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClientModule"], _angular_http__WEBPACK_IMPORTED_MODULE_6__["HttpModule"]],
      providers: [_services_validate_service__WEBPACK_IMPORTED_MODULE_15__["ValidateService"], angular2_flash_messages__WEBPACK_IMPORTED_MODULE_4__["FlashMessagesService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_16__["AuthService"], _globals__WEBPACK_IMPORTED_MODULE_17__["Globals"], _guards_auth_guard__WEBPACK_IMPORTED_MODULE_18__["AuthGuard"]],
      ...
      _createClass(ProfileComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.authService.getProfile().subscribe(function (data) {
            ...
            _this2.flashMessageService.show("You are not Authorized to this Page", {
              cssClass: "alert-danger",
              timeout: 3000
            });
  ...
  function srcAppComponentsRegisterRegisterComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function RegisterComponent(valdateService, flashMessageService, authService, router) {
        _classCallCheck(this, RegisterComponent);

        this.valdateService = valdateService;
        this.flashMessageService = flashMessageService;
        this.authService = authService;
        this.router = router;
      }
      ...
      _createClass(RegisterComponent, [{
        ...
        value: function onRegisterSubmit() {
          ...
          this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
              _this3.flashMessageService.show("You are now registered and can login.", {
                cssClass: "alert-success",
                timeout: 3000
              });
              ...
              _this3.flashMessageService.show("Something went wrong, try later.", {
                cssClass: "alert-danger",
                timeout: 3000
              });
            }
    ...
    function () {
      ...
      _createClass(ValidateService, [{
        ...
        value: function validateRegister(user) {
          if (user.first_name == undefined || user.last_name == undefined || user.email == undefined || user.username == undefined) {
            return false;
          } else {
            return true;
          }
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! E:\projects\mean\mean-auth-app\angular-src\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
