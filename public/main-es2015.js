...
let NavbarComponent = class NavbarComponent {
    constructor(authService, flashMessageService, router) {
        this.authService = authService;
        this.flashMessageService = flashMessageService;
        this.router = router;
    }
...
let RegisterComponent = class RegisterComponent {
    constructor(valdateService, flashMessageService, authService, router) {
...
module.exports = __webpack_require__(/*! E:\projects\mean\mean-auth-app\angular-src\src\main.ts */"./src/main.ts");
